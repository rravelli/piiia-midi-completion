...
class TestNotesToMidi(unittest.TestCase):
    ...
    def test_notes_to_midi_valid(self):
        ...
        # Test the function
        pm = notes_to_midi(self.sample_notes_df, out_file, 'Acoustic Grand Piano')
    ...
    def test_notes_to_midi_invalid_file_path(self):
        ...
        with self.assertRaises(FileNotFoundError, msg="No such file or directory"):
            notes_to_midi(self.sample_notes_df, '/invalid/path/test_output.mid', 'Acoustic Grand Piano')
    ...
    def test_notes_to_midi_negative_duration(self):
        ...
        with self.assertRaises(ValueError, msg="Note duration must be positive"):
            notes_to_midi(self.sample_notes_df, out_file, 'Acoustic Grand Piano')
